...
public class UpdateController extends HttpServlet {
    ...
    private static final String ERROR = "adminView.jsp";
            ...
            if (dao.getProductByID(proID) != null) {
                ...
                if (check) {
                    ...
                    if ("".equals(image.trim())) {
                        temp = dao.getProductByID(proID).getImage();
                    }
                    ProductDTO pro = new ProductDTO(proID, name, detail, temp, quantity,
                            price, sale.equals("true"), cateDAO.getCategory(cateID));
                ...
                errorAD.setErrorID("Prodcut not found!");
                request.setAttribute("ERROR_ADMIN", errorAD);
            }
